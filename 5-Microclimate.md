...
Then install Microclimate using helm:
...
If you get the status **stopped** with **Build successful**, this could occur sometimes, then skip the 2 next actions and try the Edit button in this section.
